<script>
  ...
  onMount(() => {
    ...
    console.log(
      "if you know what you're doing here, come contribute at https://github.com/artifishvr/GiveHeadpats c:"
    );
  ...
  <Navbar class="drop-shadow-sm">
    <NavBrand href="/">
      ...
      <a href="https://github.com/artifishvr/GiveHeadpats" target="_blank">
        <span
          class="ml-2 px-3 py-2 rounded-full bg-red-200 text-red-800 font-semibold"
          >Open Alpha</span>
...
<Footer class="bg-white dark:bg-slate-950 p-4 drop-shadow-lg">
  ...
  <P class="text-center text-sm text-gray-500 sm:text-center dark:text-gray-400"
    >Built with ❤️</P>
  <FooterLinkGroup
